  ...
  return (
    <section className="py-24 px-6 bg-black border-t border-gold/20">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 animate-fade-in">
          ...
          <div className="space-y-8">
            <div>
              ...
              <a 
                ...
                className="text-primary hover:text-primary/80 transition-colors text-lg tracking-wide inline-block"
              >
            ...
            {/* Social Icons */}
            <div className="pt-4">
              <p className="text-foreground/70 text-sm mb-4">Follow:</p>
              <div className="flex items-center gap-6">
                <a 
                  href="https://open.spotify.com/artist/6phLlgPzHgj6RxT3Jz4UEu?si=nrLnycUcRL6KyX5UwpgEVw" 
                  target="_blank" 
                ...
                <a 
                  href="https://music.apple.com/us/artist/mihai-gruia/1847803390" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-primary hover:text-primary/70 transition-colors"
