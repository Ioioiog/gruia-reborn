      ...
      <div className="max-w-3xl mx-auto space-y-12">
        ...
        <div className="flex gap-12">
          <div className="w-48 h-96 flex-shrink-0">
            <img alt="Mihai Gruia Portrait" className="w-full h-full object-cover grayscale" src="/lovable-uploads/19825b95-ccee-46d6-a9f0-9912255df2d3.jpg" />
          </div>

          <div className="space-y-8 flex-1">
            {timelineEvents.map((event, index) => <div key={index} className="relative pl-8 border-l border-gold/30">
